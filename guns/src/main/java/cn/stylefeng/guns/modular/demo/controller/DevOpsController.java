...
import cn.stylefeng.guns.core.model.SysUserJump;
import cn.stylefeng.guns.modular.test.service.SysUserJumpMapper;
...
public class DevOpsController {
    ...
    @Resource
    private SysUserJumpMapper sysUserJumpMapper;
    ...
    @GetResource(name = "get config", path = "/getConfig")
    public ResponseData<SysUserJump> getConfig(String sysId) {
        LambdaQueryWrapper<SysUserJump> sysUserJumpWrapper = new LambdaQueryWrapper<>();

        SysUserJump sysUserJump = sysUserJumpMapper.selectOne(sysUserJumpWrapper.eq(SysUserJump::getSysId, sysId));

        return new SuccessResponseData<>(sysUserJump);
    }
